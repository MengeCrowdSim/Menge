...
namespace StressGAS {
	...
	AgentStressor::AgentStressor() : _deltaNeighborDist(DEFAULT_NEIGHBOR_DIST_DELTA), 
		_deltaMaxNeighbors(DEFAULT_MAX_NEIGHBORS_DELTA), _deltaRadius(DEFAULT_RADIUS_DELTA),
		_deltaPrefSpeed(DEFAULT_PREF_SPEED_DELTA), _deltaTimeHorizon(DEFAULT_TIME_HORIZON_DELTA)
	{
	}

	/////////////////////////////////////////////////////////////////////

	AgentStressor::AgentStressor(float neighborDistDelta, float maxNeighborDelta,
		float radiusDelta, float prefSpeedDelta, float timeHorizonDelta) : 
		_deltaNeighborDist(neighborDistDelta), _deltaMaxNeighbors(maxNeighborDelta), 
		_deltaRadius(radiusDelta), _deltaPrefSpeed(prefSpeedDelta), 
