...
/*!
 ...
 @brief     A basic context for interacting with and displaying generalized centrifugal force agent
            parameters.
 */
...
class Agent;
/*!
 @brief		The context for displaying the computational aspects of the Generalized Centifugal Force
          model (see GCF::Agent).
 */
class AgentContext : public MengeVis::Runtime::BaseAgentContext {
 ...
 protected:
  ...
  /*!
   @brief		Determines if the foces are drawn proportionately (false) or purely the direction
            (true).
   */
  bool _onlyForceDir;
  ...
  /*!
   @brief		Draws the given force on the given agent; it assumes the force color has already been
            set.
