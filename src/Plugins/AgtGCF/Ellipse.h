...
class Ellipse {
 public:
   ...
   *the line that connects the ellipse centers.
   *	@param		other		The other ellipse
   ...
   *has been moved along its normal until it makes contact.  The obstacle is interpreted as an
   *INFINITE line.
   ...
   *point and the origin with the ellipse.  The distance is to that point.  This is *not* the
   ...
   *from the ellipse center and, ideally, outside the ellipse.
