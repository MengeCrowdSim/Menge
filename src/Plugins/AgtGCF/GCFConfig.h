...
#ifndef __GCF_CONFIG_H__
#define __GCF_CONFIG_H__

// Now set up compiler-dependent export/import symbols

#if defined(_MSC_VER)

#if defined(GCF_STATICLIB)
#define GCF_API
#else
#if defined(GCF_EXPORT)
...
#else
#if defined(GCF_EXPORT)
#define GCF_API __attribute__((visibility("default")))
#else
