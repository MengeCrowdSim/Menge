...
class EXPORT_API HeightField : public Menge::Resource {
 ...
 public:
   ...
   *of the x-z plane based on cell size and image resolution.
   *
   ...
   *is interpreted as the standard deviation of a 2D symmetric gaussian kernel.  If zero, no
   ...
   *the nearest cell center is returned.
   *
   *	@param		x		The position along the x-axis.
   *	@param		y		The position along the y-axis.
