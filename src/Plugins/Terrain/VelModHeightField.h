 ...
 *gradient. Uphill and downhill speed changes are controlled separately -- gradients which lie
 *perpindicular to the input preferred direction will cause a direction change, but no speed change.
 *
 ...
 *than larger values.  (A value of zero will leave the agent moving along their original direction,
 ...
 *1, then only a vertical surface will *completely* eliminate motion.  However, larger values wall
 *cause the agent to slow to a stop on smaller slopes.  Smaller values will cause the agent to slow
