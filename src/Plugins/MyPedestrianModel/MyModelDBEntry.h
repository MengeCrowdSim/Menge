...
/*!
 *	@file		MyModelDBEntry.h
 *	@brief		The simulator database entry for the MyModel pedestrian model.
 */

#ifndef __MYMODEL_DB_ENTRY_H__
#define	__MYMODEL_DB_ENTRY_H__
...
namespace MyModel {
	/*!
	 *	@brief		The simulator database entry for the MyModel simulator.
	 */
	class MyModelDBEntry : public Menge::SimulatorDBEntry {
	public:
		/*!
