...
/*!
 *	@file		MyModelConfig.h
 *	@brief		Configures the shared library aspect of the includes.
 */

#ifndef __MYMODEL_CONFIG_H__
#define __MYMODEL_CONFIG_H__
...
// Now set up compiler-dependent export/import symbols
  ...
  #if defined( MYMODEL_STATICLIB )
    #define MYMODEL_API
  #else
    #if defined( MYMODEL_EXPORT )
  ...
  #else
    #if defined( MYMODEL_EXPORT )
      #define MYMODEL_API __attribute__ ((visibility ("default")))
    #else
