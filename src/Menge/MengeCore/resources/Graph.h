...
namespace Menge {
    ...
    enum class Clearance {
      Partial,  ///< The connection need only be traversible (see SpatialQuery::linkIsTraversible()).
      Full      ///< The connection must be fully _visible_ (see SpatialQuery::queryVisibility()).
    };
