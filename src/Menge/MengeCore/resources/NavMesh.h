 ...
 *groups. Each group contains a contiguous block of node identifiers.
 */
class NMNodeGroup {
 public:
  /*!
 ...
 *global planning in planar or non-planar environments.
 *
 *				It represents the minimum data required to do path planning.  The
 *navigation mesh is represented in 2.5D. The boundaries of mesh's polygons are only defined on the
 *ground plane.  The nodes themselves include a definition of the polygon's plane off the plane.
 *Likewise, the vertices all lie on the plane.
 */
