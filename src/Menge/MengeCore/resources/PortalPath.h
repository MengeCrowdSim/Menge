...
class MENGE_API PortalPath {
 public:
   ...
   *deviation of heading (between planned and realized) before a new funnel algorithm is triggered
   *to improve the path.
   ...
   *words, portals in the open interval [start, end) will receive crossing values.  end will not be
   *included.
