...
class MENGE_API NavMeshEdge {
 public:
   ...
   *will not cause it to intersect the ends of the edge.
   *
   ...
   *radius can head straight towards and be guaranteed NOT to intersect with the end points of the
   *edge.  It also leads the agent to get closer to crossing the edge.
   *
   ...
   *direction is collision free, it is returned.  Otherwise, the "best" collision-free approximation
   *of that direction is returned.
   *
   *	@param		pos			The position of the agent.
   *	@param		radius		The radius of the agent.
