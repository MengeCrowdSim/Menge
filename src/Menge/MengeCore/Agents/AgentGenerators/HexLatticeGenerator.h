 ...
 **degrees*. This parameter is optional and, if excluded, defaults to a zero-degree rotation. The
 *rotation is counter-clockwise for positive values of rotation.
 */
