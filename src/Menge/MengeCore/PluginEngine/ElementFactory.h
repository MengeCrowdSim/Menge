...
class ElementFactory {
 ...
 public:
   ...
   *relative to the behavior file location.  This is the folder containing that path. It can be
   *ignored if no file system resources are used.
 ...
 protected:
   ...
   *references resources in the file system, it should be defined relative to this file location.
   *This is the folder containing that path. For elements defined in  behavior files, this will be
   *the path to that file; the same is true for those defined in scene files
