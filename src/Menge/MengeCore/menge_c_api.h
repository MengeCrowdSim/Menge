 ...
 *type and is initialized using the given behavior file and scene file.
 *
 ...
 *not provided, plugins will *not* be loaded.
 ...
 *direction of the agent, projected onto the xz plane.
 *
 *	@param		i		The index of the desired agent.
 ...
 *value returned by ExternalTriggerCount().
