...
namespace MengeVis {
	...
	namespace SceneGraph {
		...
		public:
			 ...
			 */
			inline void setTranslation( const Menge::Math::Vector3 & vec ) { 
				_xform.setTranslation( vec ); 
			}
			 ...
			 */
			inline void addTranslation( const Menge::Math::Vector3 & vec ) { 
				_xform.addTranslation( vec ); 
			}
			 ...
			 *						in degrees.
			 */
			inline void setRotationDeg( const Menge::Math::Vector3 & vec ) { 
				_xform.setRotationDeg( vec ); 
			}
			 ...
			 *						in radians.
			 */
			inline void setRotationRad( const Menge::Math::Vector3 & vec ) { 
				_xform.setRotationRad( vec ); 
			}
			 ...
			 *						in degrees.
			 */
			inline void addRotationDeg( const Menge::Math::Vector3 & vec ) { 
				_xform.addRotationDeg( vec ); 
			}
			 ...
			 *						in radians.
			 */
			inline void addRotationRad( const Menge::Math::Vector3 & vec ) { 
				_xform.addRotationRad( vec );
			}
			 ...
			 */
			inline void setRotAxisDeg( const Menge::Math::Vector3 & vec ) {
				_xform.setRotAxisDeg( vec );
			}
			 ...
			 */
			inline void setRotAxisRad( const Menge::Math::Vector3 & vec ) {
				_xform.setRotAxisRad( vec );
			}
			 ...
			 */
			inline void getInverseMatrix( Menge::Math::Matrix4x4 & mat ) {
				_xform.getInverseMatrix( mat );
			}
