...
namespace MengeVis {
	...
	namespace SceneGraph {
		...
		public:
			 ...
			 */
			Shape( float r, float g, float b, GLenum s=GL_FILL ): GLNode(), Selectable(),
																  _r(r), _g(g), _b(b), _style(s) {}
		...
		public:
			 ...
			 */
			static void drawCircle( float radius, float r, float g, float b, float a,
		...
		public:
			 ...
			 */
			Cylinder( float radius, float height, float r, float g, float b ):Shape(r,g,b),
																			  _radius(radius),
																			  _height(height){}
			 ...
			 */
			static void drawCylinder( float radius, float height, float r, float g, float b,
