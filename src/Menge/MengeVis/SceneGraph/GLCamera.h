...
namespace MengeVis {
	...
	namespace SceneGraph {
      ...
      void set_name( const std::string& name ) { _name = name;  }
			 ...
			 *								x- and y-positions of the selection point, in screen
			 *								space.
			 */
			 ...
			 *									direction.  If false, it looks in the negative
			 *									direction.
			 */
			 ...
			 *							camera to turn left, negative values turn the camera right.
			 */
			 ...
			 *							the camera to its right, negative to its left.
			 */
			 ...
			 *
			 *	@param		angle		The angle of rotation (in radians).  Positive values move
			 *							the camera in its upward direction, negative to its
			 *							downward. 
			 */
