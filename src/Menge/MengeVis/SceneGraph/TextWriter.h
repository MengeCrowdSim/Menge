...
namespace MengeVis {
	...
	namespace SceneGraph {
		...
		public:
			 ...
			 *							given amatte.  True --> superimposed, false --> matted.
			 */
			void printText( const std::string & text, Alignment alignment, float anchorX, 
							float anchorY, int fontSize, bool currColor=false, 
			 ...
			 *							or the text writer's default color should be used (false).
			 *	@param		transparent	Indicates if the text is super-imposed over the screen or
			 *							given a matte.  True --> superimposed, false --> matted.
			 */
			 ...
			 *							alignment direction.  For example, if left aligned, it goes
			 *							on the left, if right aligned, the padding is on the right.
			 ...
			 *							given a matte.  True --> superimposed, false --> matted.
			 */
			void printAlignText( const std::string & text, Alignment alignment, int fontSize,
								 float hpad, float vpad, bool currColor=false,
								 bool transparent=true );

			/*!
			 *	@brief		Prints the text anchored to the position.  The relationship to the
			 *				anchor depends on the anchor weights.  It interpolates them from bottom
			 *				left top top right.
			 *	@param		text		The string to draw.
			 *	@param		anchorX		The x-position of the anchor point (in screen coords).
			 *	@param		anchorY		The y-position of the anchor point (in screen coords).
			 ...
			 *							given a matte.  True --> superimposed, false --> matted.
			 */
			void printAnchorText( const std::string & text, float anchorX, float anchorY,
								  float xWeight, float yWeight, int fontSize, bool currColor=false,
								  bool transparent=true );
			 ...
			 */
			void textSize( const std::string & text, int fontSize, float & textWidth,
						   float & textHeight ); 
		...
		protected:
			 ...
			 *							offset this line relative to the anchor point.
			 */
			void printLine( TTF_Font * font, const char * text, float left, float bottom,
							int lineNum );
