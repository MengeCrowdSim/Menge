...
namespace MengeVis {
	...
	namespace SceneGraph {
		...
		public:
			 ...
			 *	@param		needsRedraw		Set to true if the processing of the event requires a
			 *								redraw.
			 */
			ContextResult( bool handled, bool needsRedraw ): _handled(handled),
															 _redraw(needsRedraw){}
		...
		public:
			...
			virtual bool selectGL( const GLScene * scene, const GLCamera & camera, int vWidth,
								   int vHeight, int * selectPoint ) { return false; }
