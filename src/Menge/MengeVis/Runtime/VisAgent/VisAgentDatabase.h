...
namespace MengeVis {
	namespace Runtime {
		...
		*/
		...
		template<> VisAgent *
			Runtime::VisElementDB<VisAgent, Menge::Agents::BaseAgent>::getDefaultElement();

		template<> void
			Runtime::VisElementDB<VisAgent, Menge::Agents::BaseAgent>::addBuiltins();

		template<> std::string
			Runtime::VisElementDB<VisAgent, Menge::Agents::BaseAgent>::getElementName();
