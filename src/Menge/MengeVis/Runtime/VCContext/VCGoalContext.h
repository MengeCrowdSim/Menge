...
class MENGEVIS_API GoalVCContext : public VelCompContext {
 public:
  ...
  /*!
   ...
   This string value should correspond to the getStringId method of thecorresponding simulation
   element.
   */
  virtual std::string getElementName() const;

  /*!
   @brief   Provides a string to be printed in the display as a UI elementdetailing velocity
