/*!
 *	@file		MengeContext.h
 *	@brief		The foundational context for the MengeViewer to interact with the Menge simulation.
 */
...
namespace MengeVis {
	namespace Runtime {
		 ...
		 *				simulation.  It creates a union of various other contexts: agent, velocity
